Feature: Shipment Emissions Calculations
  ...
  Scenario: Calculations starting from nothing
    ...
    Then the amount of "carbon" should be within "0.1" of "6.0"
  ...
  Scenario: Calculations from weight, package count, segment count, and distance
    ...
    When impacts are calculated
    Then the amount of "carbon" should be within "0.1" of "5.9"
  ...
  Scenario: Calculations from origin/destination zip code
    ...
    When impacts are calculated
    Then the amount of "carbon" should be within "0.1" of "0.4"
  ...
  Scenario: Calculations from origin/destination
    ...
    When impacts are calculated
    Then the amount of "carbon" should be within "0.1" of "20.8"

  Scenario: Calculations from carrier
    Given it has "carrier.name" of "FedEx"
    When impacts are calculated
    Then the amount of "carbon" should be within "0.1" of "9.1"
  ...
  Scenario Outline: Calculations from mode and origin/destination
    ...
    Then the amount of "carbon" should be within "0.1" of "<emission>"
    Examples:
      | mode    | origin      | origin_location        | destination          | destination_location   | mq_dist | emission |
      | courier | 05753       | 43.9968185,-73.1491165 | 05401                | 44.4774456,-73.2163467 | 36.5    | 5.2      |
      | courier | Lansing, MI | 42.732535,-84.5555347  | Canterbury, Kent, UK | 51.2772689,1.0805173   |         | 5.2      |
      | ground  | 05753       | 43.9968185,-73.1491165 | 05401                | 44.4774456,-73.2163467 | 36.5    | 0.3      |
  ...
  Scenario Outline: Calculations from mode, carrier, and origin/destination
    ...
    Examples:
      | mode    | origin      | origin_location        | destination          | destination_location   | mq_dist | emission |
      | courier | 05753       | 43.9968185,-73.1491165 | 05401                | 44.4774456,-73.2163467 | 36.5    | 2.3      |
  ...
  Scenario Outline: Calculations from everything
    ...
    Examples:
      | mode    | origin      | origin_location        | destination          | destination_location   | mq_dist | emission |
      | courier | 05753       | 43.9968185,-73.1491165 | 05401                | 44.4774456,-73.2163467 | 36.5    | 2.6      |
      | courier | Lansing, MI | 42.732535,-84.5555347  | Canterbury, Kent, UK | 51.2772689,1.0805173   |         | 2.6      |
      | ground  | 05753       | 43.9968185,-73.1491165 | 05401                | 44.4774456,-73.2163467 | 36.5    | 0.7      |
